...
public class ArtworkInfoLayout : MonoBehaviour
{
    ...
    public void ShowPanel(ArtworkItem artworkItem)
    {
        ...
        if (artworkItem.previewType == PreviewType.ImagePreview)
        {
            ...
            else
            {
                ...
                {
                    float sizeY = m_rectTransform.sizeDelta.y;
                    float yOffset = sizeY - (m_rectTransform.sizeDelta.y * heightToWidthRatio);
